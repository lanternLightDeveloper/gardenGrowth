...
export const weather = pgTable('weather', {
	...
	// windSpeedMax: integer('wind_speed_max'),
	// windGustMax: integer('wind_gust_max'),
	// humidityMean: integer('humidity_mean'),
	// sunshineDuration: integer('sunshine_duration'),
	// precipProbMax: integer('precip_prob_max'),
	// apparentTempMax: integer('apparent_temp_max'),
	// apparentTempMin: integer('apparent_temp_min'),
